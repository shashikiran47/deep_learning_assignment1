...
class TestFCReLU(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):
		self.net = sequential(
			########## TODO: ##########
            fc(12, 10, name="shashi_fc1"),
            relu(name = "shashi_relu1")
			########### END ###########
		)
...
class SmallFullyConnectedNetwork(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):
		self.net = sequential(
			########## TODO: ##########
            fc(4, 30, name="shashi_fc1"), 
            relu(name = "shashi_relu1"),
            fc(30, 7, name="shashi_fc2"),
            relu(name = "shashi_relu2")
			########### END ###########
		)
...
class TinyNet(object):
	def __init__(self, dropout_p=0, dtype=np.float32, seed=None):
		...
		self.net = sequential(
			########## TODO: ##########
			fc(3072, 100, name="shashi_fc1"),
			relu(name="relu1"),
			fc(100, 10, name="shashi_fc2"),
			#relu(name="relu2")
			########### END ###########
		)
